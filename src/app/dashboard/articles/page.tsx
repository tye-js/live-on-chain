            ...
            <Pagination>
              <PaginationContent>
                <PaginationItem hidden={pageNumber === 1}>
                  <PaginationPrevious
                    href={joinUrl(statusParam as ArticleStatus, pageNumber - 1)}
                  />
                </PaginationItem>
                <PaginationItem>
                  <Link href={joinUrl(statusParam as ArticleStatus, 1)}>1</Link>
                </PaginationItem>
                <PaginationItem>
                  <Link href={joinUrl(statusParam as ArticleStatus, 2)}>2</Link>
                </PaginationItem>
